...
---the name is from archaic English "I shall return anon":
...
---@return Promise # a new Promise which is fulfilled upon successful completion of either handler
...
---creates a new Promise which resolves when all of its argument resolve.
---the Promise rejects if any of its arguments reject.
---@param ... Promise[]
---@return Promise
function Promise.all(...) end

---creates a new Promise which resolves when any of its arguments resolve.
